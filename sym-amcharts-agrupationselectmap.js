(function(CS) {
    ...
    var myCustomSymbolDefinition = {
        ...
        typeName: 'amcharts-agrupationselectmap',
        displayName: 'amCharts agrupationselectmap Chart',
        datasourceBehavior: CS.Extensibility.Enums.DatasourceBehaviors.Multiple,
        iconUrl: '/Scripts/app/editor/symbols/ext/Icons/mapagrupselect.png',
            ...
            return {
                ...
                "listeners": [{
                    ...
                    "method": function(event) {
                        ...
                        event.mapObject.selectedObject = event.mapObject.dataProvider;
                        console.log("hola:" + event.selectedObject);
