(function(CS) {
    ...
    var myCustomSymbolDefinition = {
        ...
        typeName: 'amcharts-growingtable3D',
        displayName: 'amCharts growingtable3D Chart',
        datasourceBehavior: CS.Extensibility.Enums.DatasourceBehaviors.Multiple,
        iconUrl: '/Scripts/app/editor/symbols/ext/Icons/amcharts-bar3Ddising.png',
    ...
    symbolVis.prototype.init = function(scope, elem) {
        ...
        function myCustomDataUpdateFunction(newdata) {
            ...
            console.log("dataprovider es:" + dataprovider);
